...
const service = "illfonic/illchat"
...
func (p2p *P2P) AdvertiseConnect() {
	...
	// Debug log
	logrus.Debugln("Advertised the IllChat Service.")
	...
	// Trace log
	logrus.Traceln("Discovered IllChat Service Peers.")
...
func (p2p *P2P) AnnounceConnect() {
	...
	// Debug log
	logrus.Debugln("Announced the IllChat Service.")
	// Sleep to give time for the advertisment to propogate
	time.Sleep(time.Second * 5)
